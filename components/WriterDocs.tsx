  ...
  const handlePrint = () => {
    ...
    const getReferenceNumber = (formType: string) => {
      switch (formType) {
        ...
        case 'delivery': return 'Ref: WQAOPS-WH-20/2024';
        case 'crating': return 'Ref : WQAOPS-WH-03/2024';
        case 'electronicList': return 'Ref : WQAOPS-WH-04/2024';
        case 'accessorial': return 'Ref : WQAOPS-WH-15/2024';
        case 'warehouseReceipt': return 'Ref : WQAOPS-WH-01/2024';
        case 'handyman': return 'Ref : WQAOPS-WH-20/2024';
        case 'containerInspection': return 'Ref : WQAOPS-WH-22/2024';
        case 'vehicleInspection': return 'Ref : WQAOPS-WH-19/2024';
        default: return '';
      }
    };
    ...
    const addGlobalFooter = () => {
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            doc.text("Doha, Qatar", pageWidth / 2, footerY + 4, { align: "center" });
            doc.text("Phone: (974) 4 444 8814   Fax: (974) 4 444 8815", pageWidth / 2, footerY + 8, { align: "center" });
               ...
               {activeForm === 'accessorial' && (
                   <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-1.5"><label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Job Ref</label><input type="text" className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all placeholder:text-slate-400" placeholder="e.g. QA-1234" value={accessorialData.jobId} onChange={e => setAccessorialData({...accessorialData, jobId: e.target.value})} /></div>
               ...
               {(activeForm === 'packing' || activeForm === 'unpacking') && (
                 <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                       ...
                       <div className="space-y-1"><label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Job Reference</label><input type="text" className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all placeholder:text-slate-400" placeholder="e.g. QA-1234" value={activeForm === 'packing' ? packingData.jobId : unpackingData.jobId} onChange={e => activeForm === 'packing' ? setPackingData({...packingData, jobId: e.target.value}) : setUnpackingData({...unpackingData, jobId: e.target.value})} /></div>
                    </div>
               ...
               {activeForm === 'crating' && (
                   <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1.5"><label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Job Ref</label><input className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all placeholder:text-slate-400" value={cratingData.jobId} onChange={e => setCratingData({...cratingData, jobId: e.target.value})} placeholder="e.g. QA-1234" /></div>
               ...
               {activeForm === 'vehicleInspection' && (
                   <div className="space-y-8">
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                           ...
                           <div className="space-y-1.5"><label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Job Ref</label><input type="text" className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500" value={vehicleInspectionData.jobId} onChange={e => setVehicleInspectionData({...vehicleInspectionData, jobId: e.target.value})} placeholder="e.g. QA-1234" /></div>
