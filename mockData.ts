...
export const USERS: MockUser[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    profile: {
      ...
      role: UserRole.USER,
      permissions: STANDARD_ACCESS,
      avatar: 'https://api.dicebear.com/8.x/initials/svg?seed=Jubin',
      status: 'Active',
    },
  },
  {
    ...
    profile: {
      ...
      employee_id: 'OPS-103',
      name: 'Muhammed Thiyyath',
      role: UserRole.USER,
      permissions: STANDARD_ACCESS,
      avatar: 'https://api.dicebear.com/8.x/initials/svg?seed=Muhammed',
      status: 'Active',
    },
  },
  {
    ...
    profile: {
      ...
      role: UserRole.USER,
      permissions: STANDARD_ACCESS,
      avatar: 'https://api.dicebear.com/8.x/initials/svg?seed=Garima',
      status: 'Active',
    },
  },
  {
  ...
  },
  {
    ...
    profile: {
      ...
      avatar: 'https://api.dicebear.com/8.x/initials/svg?seed=Muskan',
      status: 'Active',
    },
  },
  {
    ...
    profile: {
      ...
      avatar: 'https://api.dicebear.com/8.x/initials/svg?seed=Rakhi',
      status: 'Active',
    },
  },
  {
    username: 'Accounts',
    password: 'Accountdoh@123',
    profile: {
